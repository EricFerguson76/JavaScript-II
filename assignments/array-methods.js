...
// Problem 1
let runnersCompanyName = runners.filter(runner => runner.company_name === "Lazzy");
console.log(runnersCompanyName);
// Problem 2
let lastNamesAllCaps = runners.map(runner => runner.last_name.toUpperCase());
console.log(lastNamesAllCaps);
// Problem 3
let emailAddress = [];
runners.forEach((runner) => emailAddress.push(`${runner.email}`));
